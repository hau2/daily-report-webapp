...
-- Update role check constraint to use 'owner' instead of 'manager' (from migration 004)
-- Also drop the old unique constraint and replace with a partial unique index
